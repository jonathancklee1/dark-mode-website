...
function HistoryCard({ data, index }: HistoryCardProps) {
    ...
    return (
        <div
            className={`mx-auto flex flex-col gap-2 bg-card-color p-6 text-text-color shadow-2xl md:row-span-2 md:max-w-[400px]  ${index % 2 === 0 ? 'md:col-start-1' : 'md:col-start-2'} ${gridRowStart}`}
        >
